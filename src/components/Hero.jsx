...
function Hero() {
  return (
    <div className="">
        <div className="w-screen h-screen bg-cover bg-no-repeat bg-center  flex flex-col " style={{ backgroundImage: `url(${background})` }}>
        

        <span className="text-right">Download CV
        ...
        <div className="w-full h-full bg-cover bg-no-repeat bg-center  flex flex-col items-center justify-center">           
