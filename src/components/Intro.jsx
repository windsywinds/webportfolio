...
function Intro() {
    return (
        <div className="intro">
            ...
            <p className="text-sm mb-6 font-bold">I've included some projects I've worked on below and included a contact form to get in touch. I'd love to work with you and your team!</p>
            </div>
        </div>
    )
}
