...
function Intro() {
    return (
        <div className="intro">
            ...
            <p className="text-sm mb-2 font-bold">In my spare time I love to get out for hikes to take photos, (attempt to) surf, or work on my own personal web projects.</p>
            <p className="text-sm mb-6 font-bold">I've included some notable projects I've worked on below and included a contact form to get in touch. I'd love to work with you and your team!</p>
            </div>
        </div>
    )
}
