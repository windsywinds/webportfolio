...
function Intro() {
    return (
        <div className="intro-bg">
            ...
            <p className="text-sm mb-6 font-bold">I'm also a photography enthusist, and SBINZ level 3 snowboard coach, having worked all over the world. In my spare time I (attempt to) surf, or get out for hikes so I can take more photos! </p>
            </div>
        </div>
    )
}
