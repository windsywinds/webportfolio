...
function Intro() {
    return (
        <div className="intro pb-9">
            ...
            <p className="text-sm mb-2 font-bold pt-2">In my spare time I love to get out for hikes to take photos, (attempt to) surf, or work on my own personal web projects.</p>
            <p className="text-sm mb-6 font-bold pt-5">I've included some projects I've worked on below and included a contact form to get in touch. I'd love to work with you and your team!</p>
            </div>
        </div>
    )
}
